...
path = "D:/FIIT/BP/demo_set/test"

blurred_imgs, ground_truth_imgs = [], []

blurred_imgs = [
    cv2.imread(os.path.join(path, "blur/data", f)) / 255 for f in os.listdir(os.path.join(path, "blur/data"))
]
ground_truth_imgs = [
    cv2.imread(os.path.join(path, "sharp/data", f)) / 255
    for f in os.listdir(os.path.join(path, "sharp/data"))
]
